...
namespace TenantAndLeaseManagement.Application.Commands
{
    ...
    {
        public Task<LeaseAgreementResponse> CreateLeaseAsync(string tenantName, string ownerName, DateTime creationDate, Guid individualUnitId, double monthlyRent, CancellationToken cancellationToken);
