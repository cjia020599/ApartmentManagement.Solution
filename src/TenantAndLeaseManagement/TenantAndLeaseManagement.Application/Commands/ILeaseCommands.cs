...
namespace TenantAndLeaseManagement.Application.Commands
{
    ...
    {
        public Task<LeaseAgreementResponse> CreateLeaseAsync(string tenantName, string ownerName, DateTime creationDate, DateTime terminationDate, string building, string unit, decimal monthlyRent, CancellationToken cancellationToken);
